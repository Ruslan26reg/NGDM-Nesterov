...
optimizer = tensorflow.keras.optimizers.SGD(learning_rate=0.01, momentum=0.99, nesterov = True)
model = Sequential()
model.add(layers.LSTM(128, activation = "tanh",input_shape=(X_train.shape[1], X_train.shape[2])))
